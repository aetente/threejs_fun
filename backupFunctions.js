...
function drawHand(scene, position, options) {
  ...
  // mesh.pivot.copy(pivot);
  // console.log("mesh.pivot", mesh)
  // mesh.translateX(pivot.x);
  // mesh.translateY(pivot.y);
  // mesh.translateZ(pivot.z);
  ...
  if (hasOutline) {
    ...
    // );
    // // const lineGeom = new THREE.LineSegmentsGeometry().fromEdgesGeometry(edges);

    // // // 3. Create LineMaterial with desired width
    ...
    // // const lines = new THREE.LineSegments2(lineGeom, lineMat);
    // mesh.add(line);
  }
...
function pattern1_1(scene, pointsArray, options) {
...
function pattern1_2(scene, pointsArray, options) {
  let limit = options?.limit || 50;
...
function pattern1_3(scene, pointsArray, options) {
...
function pattern1_4(scene, pointsArray, options) {
...
function pattern1_5(scene, pointsArray, options) {
...
function pattern1_6(scene, pointsArray, options) {
...
function pattern1_7(scene, pointsArray, options) {
